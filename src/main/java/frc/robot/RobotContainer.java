...
import frc.robot.subsystems.swerveDrive.SwerveDriveSubsystemVivie;
...
public class RobotContainer {
  ...
  private void configureBindings() {
    ...
    // m_driverController.b().whileTrue(driveSubsystem.driveMetersCmd(distanceSupplier));
    m_driverController.y().whileTrue(driveSubsystem.spinCmd(() -> 0));
